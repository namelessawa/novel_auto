...
> 本文记录首次重构验收，已被随后发现的 seed 来源、delta evidence 和提交 revision 漏洞所取代。修复后的结论与命令以 [Author 权威链加固验收](./author-mode-authority-hardening-20260722.md) 为准；不得继续引用本文“无高/中风险”的旧结论作为当前证据。
